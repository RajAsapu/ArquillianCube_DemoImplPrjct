...
public class ListFormulaMethods extends GenericWebElementMethods {
    ...
    public String applyFilter(String filter) throws Exception {
        String temp = null;
    ...
    public void verifyIfFilterIsApplied(String filter) throws Exception {
        switch (filter.toLowerCase()) {
            case "name":
    ...
    public void clickOnButton(String button) throws Exception {
        switch (button.toLowerCase()) {
            case "edit":
                clickButton(Constants.formulaList_editAction_xpath);
                break;
            case "update":
                clickButton(Constants.formulaList_updateAction_xpath);
                break;
            case "view":
                clickButton(Constants.formulaList_viewAction_xpath);
                break;
            case "copy":
                clickButton(Constants.formulaList_copyAction_xpath);
                break;
            case "name":
                clickButton(Constants.formulaList_name_xpath);
                break;
            case "description":
                clickButton(Constants.formulaList_description_xpath);
                break;
            case "expression":
                clickButton(Constants.formulaList_expression_xpath);
                break;
            case "startdate":
                clickButton(Constants.formulaList_startDate_xpath);
                break;
            case "enddate":
                clickButton(Constants.formulaList_endDate_xpath);
                break;
            case "rounding precision":
                clickButton(Constants.formulaList_roundingPrecision_xpath);
                break;
            case "type":
                clickButton(Constants.formulaList_type_xpath);
                break;
            case "status":
                clickButton(Constants.formulaList_status_xpath);
                break;
    ...
    public void verifyIfFormulaIsInactivated() throws Exception {
        /*
