...
public class ListIndexMethods extends GenericWebElementMethods {
    ...
    public void addScaleParamater()throws Exception
    {
     ...
     */
    public void clickOnAction(String action)throws Exception{
    ...
    public void verifySearchResults(String value,Column clmn)throws Exception{
        ...
        for (WebElement temp : list) {
            if (!temp.getText().equalsIgnoreCase(value)) {
                throw new Exception("Column values Doesn't match, Expected :" + value + " Actual:" + temp.getText());
            }
        }
    }
